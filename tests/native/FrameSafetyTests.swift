...
@main struct FrameSafetyTests {
    static func main() {
        ...
        check(clipboardChordAllowed(names: ["CMD","V"], paste: true), "the paste the user asked for is allowed")
        check(!clipboardChordAllowed(names: ["CMD","V"], paste: false), "an unmarked paste is refused")
        check(!clipboardChordAllowed(names: ["CMD","C"], paste: true), "copy is refused even when a paste was asked for")
        check(!clipboardChordAllowed(names: ["CMD","X"], paste: true), "cut is refused even when a paste was asked for")
        check(!clipboardChordAllowed(names: ["CMD","SHIFT","V"], paste: true), "a modified paste chord is refused")
        check(clipboardChordAllowed(names: ["CMD","L"], paste: false), "non-clipboard chords are unaffected")
