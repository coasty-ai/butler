...
@main struct FrameSafetyTests {
    static func main() {
        ...
        check(pointerTakeover(previous:cursor,current:CGPoint(x:301,y:400),deltaX:1,deltaY:0,graceActive:false), "small hardware movement outside grace is takeover")
