...
3. Leave TextEdit, Calendar, Reminders, Music and System Settings closed with nothing unsaved. The harness never quits an application; a cycle skips the long tasks of any that is open at its start (`APPS_OPEN`).
